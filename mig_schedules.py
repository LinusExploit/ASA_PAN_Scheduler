...
for s in schedules:
    ...
    #print(s_clock)
    #print(s_year)
    print("set device-group {} schedule {} schedule-type non-recurring {}/{}/{}@{}-{}/{}/{}@{}").format(dgname, s_name, s_year, months[s_month], s_day, s_clock, l_year, months_linux[l_month], l_day,l_clock)
